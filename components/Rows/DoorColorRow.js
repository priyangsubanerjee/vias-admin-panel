...
import AddDoor from "../Modals/AddDoor";
...
function DoorColorRow({ doorColor, refreshDoorColors }) {
  ...
  const [editDoorOpen, setEditDoorOpen] = React.useState(false);
  ...
  return (
    <>
      ...
      {editDoorOpen && (
        <AddDoor
          addDoorOpen={editDoorOpen}
          setAddDoorOpen={setEditDoorOpen}
          doorCtx={doorColor}
        />
      )}
      {loading && (
